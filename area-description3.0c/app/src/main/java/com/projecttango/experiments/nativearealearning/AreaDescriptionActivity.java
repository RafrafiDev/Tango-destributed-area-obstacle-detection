...
import com.projecttango.experiments.functionality.gps;
...
public class AreaDescriptionActivity extends Activity implements
  ...
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
     L = new gps(getApplicationContext());
    ...
    mLoadr = (Button) findViewById(R.id.loadr);
    mLoadr.setOnClickListener(this);
    ...
    mOutput.setText(gps.toString(L));
  ...
  protected void onResume() {
    super.onResume();
    mGLView.onResume();
    TangoJNINative.setupConfigAndConnect(mIsLearning, mIsUsingADF,gps.toString(L));
    if (mIsUsingADF) {
  ...
  public void onClick(View v) {
    switch (v.getId()) {
      ...
      case R.id.loadr:
        ...
        TangoJNINative.setupConfigAndConnect(false, true,gps.toString(L));
        mADFUUIDTextView.setText("Number of ADFs: " + String.valueOf(TangoJNINative.getADFCount()) +
                ", latest ADFs UUID: " + TangoJNINative.getUUID());
  ...
  public void setNameAndUUID(String name, String uuid) {
    String loc = gps.toString(L);
    TangoJNINative.setUUIDMetadataValue(uuid, "name", name.length()+loc.length(), loc+name);
    TangoJNINative.saveExtra(loc+name);
  ...
  private void updateUIs() {
    ...
    mOutput.setText(TangoJNINative.testfuncstring());
  }
}
