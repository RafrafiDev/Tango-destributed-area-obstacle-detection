...
public class TangoJNINative {
  ...
  public static native void saveExtra(String filename);

  public static native int initialize(Object activity);

  public static native void setupConfigAndConnect(boolean isLearning, boolean isLoadedADF,String gpsvalues);
  ...
  public static native String testfuncstring();
