...
public class TangoJNINative {
  ...
  public static native void tcpConnect();

  public static native void tcpDisconnect();

  public static native void testButton();

  public static native float[] getFloatDepthData();

  public static native double[] getDoubleDepthData();

  public static native void setFloatDepthData(float[] array,int lenght);
  ...
  public static native int getDecision();
  ...
  public static native String getStringDepthData();
